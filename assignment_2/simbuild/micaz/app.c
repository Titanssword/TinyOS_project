...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x403e42a8, const void *arg_0x403e4440);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x404395c0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x40588840), 
int (*key_eq_fn)(void *arg_0x40588c88, void *arg_0x40588e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x406be9b8, int arg_0x406beb10);
static double RandomUniform(void );
...
enum SimpleTransceiverAppC$__nesc_unnamed4332 {
  SimpleTransceiverAppC$AM_SIMPLE_TRANSCEIVER_MSG = 10
};
typedef TMilli SimpleTransceiverC$LocalTime$precision_tag;
typedef TMilli SimpleTransceiverC$Timer1$precision_tag;
typedef TMilli SimpleTransceiverC$MilliTimer$precision_tag;
...
static void SimpleTransceiverC$AMControl$startDone(error_t error);
#line 138
static void SimpleTransceiverC$AMControl$stopDone(error_t error);
# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
static void SimpleTransceiverC$Boot$booted(void );
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void SimpleTransceiverC$AMSend$sendDone(
#line 103
message_t * msg, 
...
static void SimpleTransceiverC$Timer1$fired(void );
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
SimpleTransceiverC$Receive$receive(
#line 71
message_t * msg, 
void * payload, 
...
uint8_t len);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void SimpleTransceiverC$MilliTimer$fired(void );
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t SimpleTransceiverC$AMControl$start(void );
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t SimpleTransceiverC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
SimpleTransceiverC$Packet$getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 61 "/opt/tinyos-2.1.2/tos/lib/timer/LocalTime.nc"
static uint32_t SimpleTransceiverC$LocalTime$get(void );
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void SimpleTransceiverC$Timer1$startPeriodic(uint32_t dt);
# 46 "/opt/tinyos-2.1.2/tos/interfaces/Random.nc"
static uint32_t SimpleTransceiverC$Random$rand32(void );
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void SimpleTransceiverC$MilliTimer$startOneShot(uint32_t dt);
# 88 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
static am_addr_t SimpleTransceiverC$AMPacket$source(
#line 84
message_t * amsg);
# 29 "SimpleTransceiverC.nc"
int SimpleTransceiverC$round[1000];
message_t SimpleTransceiverC$packet[1000];
message_t SimpleTransceiverC$ts[1000];

uint32_t SimpleTransceiverC$start_time[1000];
uint32_t SimpleTransceiverC$temp_time[1000];
int SimpleTransceiverC$temp_order[1000];


bool SimpleTransceiverC$locked[1000];


uint32_t SimpleTransceiverC$max[1000];

float SimpleTransceiverC$random_NODE[1000];
int SimpleTransceiverC$want[1000];



int SimpleTransceiverC$j[1000];
int SimpleTransceiverC$count[1000];
int SimpleTransceiverC$order[1000][4];
int SimpleTransceiverC$timestamps[1000][4];

simple_transceiver_t *SimpleTransceiverC$rcm[1000];
simple_transceiver_t *SimpleTransceiverC$rcm2[1000];
simple_transceiver_t *SimpleTransceiverC$rcm3[1000];
simple_transceiver_t *SimpleTransceiverC$rcm4[1000];
simple_transceiver_t *SimpleTransceiverC$rcm5[1000];


static inline void SimpleTransceiverC$Boot$booted(void );



static inline void SimpleTransceiverC$AMControl$startDone(error_t err);
#line 76
static inline void SimpleTransceiverC$AMControl$stopDone(error_t err);



static inline void SimpleTransceiverC$MilliTimer$fired(void );
#line 100
static inline message_t *SimpleTransceiverC$Receive$receive(message_t *bufPtr, void *payload, uint8_t len);
#line 265
static inline void SimpleTransceiverC$Timer1$fired(void );
#line 286
static inline void SimpleTransceiverC$AMSend$sendDone(message_t *bufPtr, error_t error);
# 46 "/opt/tinyos-2.1.2/tos/interfaces/GeneralIO.nc"
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static error_t /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t SimpleTransceiverC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void * SimpleTransceiverC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 126
# 88 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static am_addr_t SimpleTransceiverC$AMPacket$source(message_t * amsg){
#line 88
  unsigned short __nesc_result;
#line 88
...
#line 88
# 46 "/opt/tinyos-2.1.2/tos/interfaces/Random.nc"
inline static uint32_t SimpleTransceiverC$Random$rand32(void ){
#line 46
...
# 61 "/opt/tinyos-2.1.2/tos/lib/timer/LocalTime.nc"
inline static uint32_t SimpleTransceiverC$LocalTime$get(void ){
#line 61
  unsigned int __nesc_result;
#line 61
...
#line 100
{
  ...
  if (len == 1) {
      ...
      SimpleTransceiverC$want[sim_node()] = 1;
      sim_log_debug(149U, "SimpleTransceiverC", "I'm activated \n");



      SimpleTransceiverC$rcm[sim_node()] = (simple_transceiver_t *)SimpleTransceiverC$Packet$getPayload(&SimpleTransceiverC$ts[sim_node()], sizeof(simple_transceiver_t *));

      __nesc_hton_uint16(SimpleTransceiverC$rcm[sim_node()]->timestamp.nxdata, SimpleTransceiverC$LocalTime$get() + (float )SimpleTransceiverC$Random$rand32() / SimpleTransceiverC$max[sim_node()] * 50000);
      SimpleTransceiverC$timestamps[sim_node()][0] = __nesc_ntoh_uint16(SimpleTransceiverC$rcm[sim_node()]->timestamp.nxdata);
      SimpleTransceiverC$order[sim_node()][0] = TOS_NODE_ID;
      sim_log_debug(150U, "SimpleTransceiverC", "I'm %d $$$$$$$$ my t[0] is %d\n", TOS_NODE_ID, SimpleTransceiverC$timestamps[sim_node()][0]);

      if (SimpleTransceiverC$AMSend$send(AM_BROADCAST_ADDR, &SimpleTransceiverC$ts[sim_node()], sizeof(simple_transceiver_t )) == SUCCESS) {

          SimpleTransceiverC$locked[sim_node()] = TRUE;
        }
    }
  else {
    if (len == sizeof(simple_transceiver_t )) {

        if (SimpleTransceiverC$want[sim_node()] == 0) 
          {
            sim_log_debug(151U, "SimpleTransceiverC", "get from %d and I don't want it\n", SimpleTransceiverC$AMPacket$source(bufPtr));
          }
        else {
#line 131
          if (SimpleTransceiverC$want[sim_node()] == 1) 
            {
#line 132
              SimpleTransceiverC$count[sim_node()]++;
              sim_log_debug(152U, "SimpleTransceiverC", "get from %d and I  want it\n", SimpleTransceiverC$AMPacket$source(bufPtr));
              SimpleTransceiverC$rcm2[sim_node()] = (simple_transceiver_t *)payload;
              SimpleTransceiverC$start_time[sim_node()] = __nesc_ntoh_uint16(SimpleTransceiverC$rcm2[sim_node()]->timestamp.nxdata);
              SimpleTransceiverC$timestamps[sim_node()][SimpleTransceiverC$count[sim_node()]] = SimpleTransceiverC$start_time[sim_node()];
              SimpleTransceiverC$order[sim_node()][SimpleTransceiverC$count[sim_node()]] = SimpleTransceiverC$AMPacket$source(bufPtr);
              for (SimpleTransceiverC$j[sim_node()] = SimpleTransceiverC$count[sim_node()]; SimpleTransceiverC$j[sim_node()] > 0; SimpleTransceiverC$j[sim_node()]--) {
                  if (SimpleTransceiverC$timestamps[sim_node()][SimpleTransceiverC$j[sim_node()]] < SimpleTransceiverC$timestamps[sim_node()][SimpleTransceiverC$j[sim_node()] - 1]) 
                    {
                      SimpleTransceiverC$temp_time[sim_node()] = SimpleTransceiverC$timestamps[sim_node()][SimpleTransceiverC$j[sim_node()] - 1];
                      SimpleTransceiverC$timestamps[sim_node()][SimpleTransceiverC$j[sim_node()] - 1] = SimpleTransceiverC$timestamps[sim_node()][SimpleTransceiverC$j[sim_node()]];
                      SimpleTransceiverC$timestamps[sim_node()][SimpleTransceiverC$j[sim_node()]] = SimpleTransceiverC$temp_time[sim_node()];
                      SimpleTransceiverC$temp_order[sim_node()] = SimpleTransceiverC$order[sim_node()][SimpleTransceiverC$j[sim_node()] - 1];
                      SimpleTransceiverC$order[sim_node()][SimpleTransceiverC$j[sim_node()] - 1] = SimpleTransceiverC$order[sim_node()][SimpleTransceiverC$j[sim_node()]];
                      SimpleTransceiverC$order[sim_node()][SimpleTransceiverC$j[sim_node()]] = SimpleTransceiverC$temp_order[sim_node()];
                    }
                  else {

                    if (SimpleTransceiverC$timestamps[sim_node()][SimpleTransceiverC$j[sim_node()]] == SimpleTransceiverC$timestamps[sim_node()][SimpleTransceiverC$j[sim_node()] - 1]) {
                        if (SimpleTransceiverC$order[sim_node()][SimpleTransceiverC$j[sim_node()]] < SimpleTransceiverC$order[sim_node()][SimpleTransceiverC$j[sim_node()] - 1]) {
                            SimpleTransceiverC$temp_time[sim_node()] = SimpleTransceiverC$timestamps[sim_node()][SimpleTransceiverC$j[sim_node()] - 1];
                            SimpleTransceiverC$timestamps[sim_node()][SimpleTransceiverC$j[sim_node()] - 1] = SimpleTransceiverC$timestamps[sim_node()][SimpleTransceiverC$j[sim_node()]];
                            SimpleTransceiverC$timestamps[sim_node()][SimpleTransceiverC$j[sim_node()]] = SimpleTransceiverC$temp_time[sim_node()];
                            SimpleTransceiverC$temp_order[sim_node()] = SimpleTransceiverC$order[sim_node()][SimpleTransceiverC$j[sim_node()] - 1];
...
#line 194
              sim_log_debug(153U, "SimpleTransceiverC", " %d>%d>%d>%d \n", SimpleTransceiverC$order[sim_node()][0], SimpleTransceiverC$order[sim_node()][1], SimpleTransceiverC$order[sim_node()][2], SimpleTransceiverC$order[sim_node()][3]);



              if (SimpleTransceiverC$count[sim_node()] == 3) 
                {
                  if (SimpleTransceiverC$order[sim_node()][0] == TOS_NODE_ID) 
                    {
                      sim_log_debug(154U, "SimpleTransceiverC", "Node %d is running\n", TOS_NODE_ID);

                      sim_log_debug(155U, "SimpleTransceiverC", "Node %d told Node %d to run\n", TOS_NODE_ID, SimpleTransceiverC$order[sim_node()][1]);
                      SimpleTransceiverC$rcm3[sim_node()] = (simple_transceiver_t *)SimpleTransceiverC$Packet$getPayload(&SimpleTransceiverC$ts[sim_node()], sizeof(simple_transceiver_t *));

                      __nesc_hton_uint16(SimpleTransceiverC$rcm3[sim_node()]->a[0].nxdata, SimpleTransceiverC$order[sim_node()][0]);
                      __nesc_hton_uint16(SimpleTransceiverC$rcm3[sim_node()]->a[1].nxdata, SimpleTransceiverC$order[sim_node()][1]);
                      __nesc_hton_uint16(SimpleTransceiverC$rcm3[sim_node()]->a[2].nxdata, SimpleTransceiverC$order[sim_node()][2]);
                      __nesc_hton_uint16(SimpleTransceiverC$rcm3[sim_node()]->a[3].nxdata, SimpleTransceiverC$order[sim_node()][3]);
                      __nesc_hton_uint16(SimpleTransceiverC$rcm3[sim_node()]->round.nxdata, 1);

                      if (SimpleTransceiverC$AMSend$send(SimpleTransceiverC$order[sim_node()][1], &SimpleTransceiverC$ts[sim_node()], 4) == SUCCESS) {
...
#line 237
      if (len == 4) {
          SimpleTransceiverC$rcm4[sim_node()] = (simple_transceiver_t *)payload;
          SimpleTransceiverC$round[sim_node()] = __nesc_ntoh_uint16(SimpleTransceiverC$rcm4[sim_node()]->round.nxdata);
          if (SimpleTransceiverC$round[sim_node()] <= 3) 
            {
#line 241
              SimpleTransceiverC$temp_order[sim_node()] = __nesc_ntoh_uint16(SimpleTransceiverC$rcm4[sim_node()]->a[SimpleTransceiverC$round[sim_node()]].nxdata);

              sim_log_debug(156U, "SimpleTransceiverC", "Node %d is running\n", TOS_NODE_ID);
              if (SimpleTransceiverC$round[sim_node()] < 3) {
                sim_log_debug(157U, "SimpleTransceiverC", "Node %d told Node %d to run\n", TOS_NODE_ID, SimpleTransceiverC$order[sim_node()][SimpleTransceiverC$round[sim_node()] + 1]);
                }
#line 246
              SimpleTransceiverC$rcm5[sim_node()] = (simple_transceiver_t *)SimpleTransceiverC$Packet$getPayload(&SimpleTransceiverC$ts[sim_node()], sizeof(simple_transceiver_t *));
              __nesc_hton_uint16(SimpleTransceiverC$rcm5[sim_node()]->round.nxdata, SimpleTransceiverC$round[sim_node()] + 1);
              __nesc_hton_uint16(SimpleTransceiverC$rcm5[sim_node()]->a[0].nxdata, __nesc_ntoh_uint16(SimpleTransceiverC$rcm4[sim_node()]->a[0].nxdata));
              __nesc_hton_uint16(SimpleTransceiverC$rcm5[sim_node()]->a[1].nxdata, __nesc_ntoh_uint16(SimpleTransceiverC$rcm4[sim_node()]->a[1].nxdata));
              __nesc_hton_uint16(SimpleTransceiverC$rcm5[sim_node()]->a[2].nxdata, __nesc_ntoh_uint16(SimpleTransceiverC$rcm4[sim_node()]->a[2].nxdata));
              __nesc_hton_uint16(SimpleTransceiverC$rcm5[sim_node()]->a[3].nxdata, __nesc_ntoh_uint16(SimpleTransceiverC$rcm4[sim_node()]->a[3].nxdata));
              if (SimpleTransceiverC$AMSend$send(SimpleTransceiverC$order[sim_node()][SimpleTransceiverC$round[sim_node()] + 1], &SimpleTransceiverC$ts[sim_node()], 4) == SUCCESS) {
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x40918ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x40918ac8) {
#line 78
    case 10:
#line 78
      __nesc_result = SimpleTransceiverC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x40918ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
inline static void /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
#line 162
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x40ca4490, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x40ca4490, addr, msg, len);
#line 80
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x40918108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x40918108, msg, error);
#line 110
}
#line 110
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x40915178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x40915178, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t SimpleTransceiverC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void SimpleTransceiverC$Timer1$startPeriodic(uint32_t dt){
#line 64
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startPeriodic(1U, dt);
#line 64
}
#line 64
# 64 "SimpleTransceiverC.nc"
static inline void SimpleTransceiverC$AMControl$startDone(error_t err)
#line 64
{
  if (err == SUCCESS) {
      if (((TOS_NODE_ID == 10 || TOS_NODE_ID == 11) || TOS_NODE_ID == 12) || TOS_NODE_ID == 13) {
        SimpleTransceiverC$Timer1$startPeriodic(3000);
        }
    }
  else 
    {
      SimpleTransceiverC$AMControl$start();
    }
}
...
#line 113
  SimpleTransceiverC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  SimpleTransceiverC$AMControl$stopDone(error);
#line 138
}
#line 138
  ...
  if (error == SUCCESS) 
    {
      ...
      SimpleTransceiverC$locked[sim_node()] = FALSE;
    }
}

# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  SimpleTransceiverC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x40ca7a90, message_t * msg, error_t error){
#line 100
  switch (arg_0x40ca7a90) {
#line 100
    case 0U:
#line 100
      /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x40ca7a90, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x4075a630){
#line 75
  switch (arg_0x4075a630) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x4075a630);
#line 75
      break;
#line 75
    }
...
#line 75
# 80 "SimpleTransceiverC.nc"
static inline void SimpleTransceiverC$MilliTimer$fired(void )
#line 80
{

  if (SimpleTransceiverC$locked[sim_node()]) {
      return;
    }
  else {
...
#line 90
        if (SimpleTransceiverC$AMSend$send(AM_BROADCAST_ADDR, &SimpleTransceiverC$packet[sim_node()], 1) == SUCCESS) {

            SimpleTransceiverC$start_time[sim_node()] = SimpleTransceiverC$LocalTime$get();
            sim_log_debug(148U, "SimpleTransceiverC", "send at %d\n", SimpleTransceiverC$start_time[sim_node()]);
            SimpleTransceiverC$locked[sim_node()] = TRUE;
          }
        }
    }
...
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void SimpleTransceiverC$MilliTimer$startOneShot(uint32_t dt){
#line 73
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShot(0U, dt);
#line 73
}
#line 73
# 265 "SimpleTransceiverC.nc"
static inline void SimpleTransceiverC$Timer1$fired(void )
#line 265
{

  SimpleTransceiverC$random_NODE[sim_node()] = (float )SimpleTransceiverC$Random$rand32() / SimpleTransceiverC$max[sim_node()] * 10;
  sim_log_debug(158U, "SimpleTransceiverC", "randomNOde: %f\n", SimpleTransceiverC$random_NODE[sim_node()]);
  if (SimpleTransceiverC$random_NODE[sim_node()] < 3 && TOS_NODE_ID == 10) {

    SimpleTransceiverC$MilliTimer$startOneShot(0);
    }
  else {
#line 272
    if (SimpleTransceiverC$random_NODE[sim_node()] > 3 && SimpleTransceiverC$random_NODE[sim_node()] < 6 && TOS_NODE_ID == 11) {

      SimpleTransceiverC$MilliTimer$startOneShot(0);
      }
    else {
#line 275
      if (SimpleTransceiverC$random_NODE[sim_node()] > 6 && SimpleTransceiverC$random_NODE[sim_node()] < 9 && TOS_NODE_ID == 12) {

        SimpleTransceiverC$MilliTimer$startOneShot(0);
        }
      else {
#line 278
        if (SimpleTransceiverC$random_NODE[sim_node()] > 9 && TOS_NODE_ID == 13) {
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40c543a8){
#line 83
  switch (arg_0x40c543a8) {
#line 83
    case 0U:
#line 83
      SimpleTransceiverC$MilliTimer$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      SimpleTransceiverC$Timer1$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40c543a8);
#line 83
      break;
#line 83
    }
...
#line 60
  SimpleTransceiverC$Boot$booted();
#line 60
}
#line 60
...
#line 55
{
  /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 10);
  return /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module SimpleTransceiverC */
  if (!strcmp(varname, "SimpleTransceiverC$round"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$round[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$round[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTransceiverC$packet"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$packet[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTransceiverC$ts"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$ts[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$ts[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTransceiverC$start_time"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$start_time[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$start_time[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTransceiverC$temp_time"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$temp_time[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$temp_time[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTransceiverC$temp_order"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$temp_order[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$temp_order[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTransceiverC$locked"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$locked[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$locked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTransceiverC$max"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$max[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$max[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTransceiverC$random_NODE"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$random_NODE[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$random_NODE[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTransceiverC$want"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$want[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$want[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTransceiverC$j"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$j[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$j[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTransceiverC$count"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$count[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$count[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTransceiverC$order"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$order[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$order[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTransceiverC$timestamps"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$timestamps[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$timestamps[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTransceiverC$rcm"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$rcm[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$rcm[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTransceiverC$rcm2"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$rcm2[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$rcm2[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTransceiverC$rcm3"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$rcm3[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$rcm3[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTransceiverC$rcm4"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$rcm4[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$rcm4[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTransceiverC$rcm5"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$rcm5[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$rcm5[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module SimpleTransceiverC */
  memset((void *)&SimpleTransceiverC$round[__nesc_mote], 0, sizeof SimpleTransceiverC$round[__nesc_mote]);
  memset((void *)&SimpleTransceiverC$packet[__nesc_mote], 0, sizeof SimpleTransceiverC$packet[__nesc_mote]);
  memset((void *)&SimpleTransceiverC$ts[__nesc_mote], 0, sizeof SimpleTransceiverC$ts[__nesc_mote]);
  memset((void *)&SimpleTransceiverC$start_time[__nesc_mote], 0, sizeof SimpleTransceiverC$start_time[__nesc_mote]);
  memset((void *)&SimpleTransceiverC$temp_time[__nesc_mote], 0, sizeof SimpleTransceiverC$temp_time[__nesc_mote]);
  memset((void *)&SimpleTransceiverC$temp_order[__nesc_mote], 0, sizeof SimpleTransceiverC$temp_order[__nesc_mote]);
  memset((void *)&SimpleTransceiverC$locked[__nesc_mote], 0, sizeof SimpleTransceiverC$locked[__nesc_mote]);
  SimpleTransceiverC$max[__nesc_mote] = 2147483647;
  memset((void *)&SimpleTransceiverC$random_NODE[__nesc_mote], 0, sizeof SimpleTransceiverC$random_NODE[__nesc_mote]);
  SimpleTransceiverC$want[__nesc_mote] = 0;
  SimpleTransceiverC$j[__nesc_mote] = 0;
  SimpleTransceiverC$count[__nesc_mote] = 0;
  memcpy((void *)&SimpleTransceiverC$order[__nesc_mote], (void *)&(int [4]){  }, sizeof SimpleTransceiverC$order[__nesc_mote]);
  memcpy((void *)&SimpleTransceiverC$timestamps[__nesc_mote], (void *)&(int [4]){ 99999999, 99999999, 99999999, 99999999 }, sizeof SimpleTransceiverC$timestamps[__nesc_mote]);
  memset((void *)&SimpleTransceiverC$rcm[__nesc_mote], 0, sizeof SimpleTransceiverC$rcm[__nesc_mote]);
  memset((void *)&SimpleTransceiverC$rcm2[__nesc_mote], 0, sizeof SimpleTransceiverC$rcm2[__nesc_mote]);
  memset((void *)&SimpleTransceiverC$rcm3[__nesc_mote], 0, sizeof SimpleTransceiverC$rcm3[__nesc_mote]);
  memset((void *)&SimpleTransceiverC$rcm4[__nesc_mote], 0, sizeof SimpleTransceiverC$rcm4[__nesc_mote]);
  memset((void *)&SimpleTransceiverC$rcm5[__nesc_mote], 0, sizeof SimpleTransceiverC$rcm5[__nesc_mote]);
