...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x403da2a8, const void *arg_0x403da440);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x4042f5c0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x4057e840), 
int (*key_eq_fn)(void *arg_0x4057ec88, void *arg_0x4057ee00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x406b49b8, int arg_0x406b4b10);
static double RandomUniform(void );
...
enum SimpleTransceiverAppC$__nesc_unnamed4331 {
...
uint8_t len);
#line 123
static uint8_t /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$maxPayloadLength(void );
...
uint8_t len);
#line 123
static uint8_t SimpleTransceiverC$AMSend$maxPayloadLength(void );
# 61 "/opt/tinyos-2.1.2/tos/lib/timer/LocalTime.nc"
...
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void SimpleTransceiverC$MilliTimer$startPeriodic(uint32_t dt);
# 85 "/opt/tinyos-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
static bool SimpleTransceiverC$PacketAcknowledgements$wasAcked(
#line 80
message_t * msg);
# 88 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
...
#line 84
message_t * amsg);
# 28 "SimpleTransceiverC.nc"
message_t SimpleTransceiverC$packet[1000];
int SimpleTransceiverC$t[1000];
uint32_t SimpleTransceiverC$start_time[1000];
uint32_t SimpleTransceiverC$end_time[1000];
uint32_t SimpleTransceiverC$during_time[1000];
bool SimpleTransceiverC$locked[1000];
uint16_t SimpleTransceiverC$counter[1000];
uint16_t SimpleTransceiverC$nCountACK[1000];
uint32_t SimpleTransceiverC$max[1000];
uint32_t SimpleTransceiverC$random_time[1000];
am_addr_t SimpleTransceiverC$addr[1000];
...
uint8_t len);
#line 112
static uint8_t /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$maxPayloadLength(void );
...
static inline uint8_t /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$maxPayloadLength(void );
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
#line 77
{
  ...
  if (len == 5) {
      ...
      SimpleTransceiverC$end_time[sim_node()] = SimpleTransceiverC$LocalTime$get();
      SimpleTransceiverC$during_time[sim_node()] = SimpleTransceiverC$end_time[sim_node()] - SimpleTransceiverC$start_time[sim_node()];

      if (SimpleTransceiverC$during_time[sim_node()] <= SimpleTransceiverC$t[sim_node()]) {
          sim_log_debug(148U, "SimpleTransceiverC", "sucess\n");
        }
      else {
          sim_log_debug(149U, "SimpleTransceiverC", "failed\n");
        }
    }
  else {


      SimpleTransceiverC$addr[sim_node()] = SimpleTransceiverC$AMPacket$source(bufPtr);
      SimpleTransceiverC$random_time[sim_node()] = (float )SimpleTransceiverC$Random$rand32() / SimpleTransceiverC$max[sim_node()] * 2 * SimpleTransceiverC$t[sim_node()];

      SimpleTransceiverC$Timer1$startOneShot(SimpleTransceiverC$random_time[sim_node()]);
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x4090eac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x4090eac8) {
#line 78
    case 10:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x4090eac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x4090c178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x4090c178, msg, payload, len);
#line 78
...
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void SimpleTransceiverC$MilliTimer$startPeriodic(uint32_t dt){
#line 64
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startPeriodic(0U, dt);
#line 64
}
#line 64
# 44 "SimpleTransceiverC.nc"
static inline void SimpleTransceiverC$AMControl$startDone(error_t err)
#line 44
{
  if (err == SUCCESS) {
      ...
      SimpleTransceiverC$MilliTimer$startPeriodic(2500);
    }
  else {
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x4090e108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x4090e108, msg, error);
#line 110
}
#line 110
...
# 85 "/opt/tinyos-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
inline static bool SimpleTransceiverC$PacketAcknowledgements$wasAcked(message_t * msg){
#line 85
  unsigned char __nesc_result;
#line 85
...
#line 118
{
  ...
  if (SimpleTransceiverC$PacketAcknowledgements$wasAcked(bufPtr)) {
    SimpleTransceiverC$nCountACK[sim_node()]++;
    }
}
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x40c6da90, message_t * msg, error_t error){
#line 100
  switch (arg_0x40c6da90) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x40c6da90, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x40750630){
#line 75
  switch (arg_0x40750630) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x40750630);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x40c6a490, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x40c6a490, addr, msg, len);
#line 80
...
inline static uint8_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$maxPayloadLength(am_id_t arg_0x40c6a490){
#line 123
  unsigned char __nesc_result;
#line 123

#line 123
  __nesc_result = TossimActiveMessageC$AMSend$maxPayloadLength(arg_0x40c6a490);
#line 123
...
inline static uint8_t /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$maxPayloadLength(void ){
#line 112
  unsigned char __nesc_result;
#line 112
...
#line 69
{
  return /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$maxPayloadLength();
}

# 123 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static uint8_t SimpleTransceiverC$AMSend$maxPayloadLength(void ){
#line 123
  unsigned char __nesc_result;
#line 123

#line 123
  __nesc_result = /*SimpleTransceiverAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$maxPayloadLength();
#line 123
...
#line 80
# 59 "SimpleTransceiverC.nc"
static inline void SimpleTransceiverC$MilliTimer$fired(void )
#line 59
{
  SimpleTransceiverC$counter[sim_node()]++;
  ...
  if (SimpleTransceiverC$locked[sim_node()]) {
      ...
      if (SimpleTransceiverC$AMSend$send(AM_BROADCAST_ADDR, &SimpleTransceiverC$packet[sim_node()], SimpleTransceiverC$AMSend$maxPayloadLength()) == SUCCESS) {
...
#line 112
{
  ...
  SimpleTransceiverC$AMSend$send(SimpleTransceiverC$addr[sim_node()], &SimpleTransceiverC$packet[sim_node()], 5);
}
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40c1d3a8){
#line 83
  switch (arg_0x40c1d3a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40c1d3a8);
#line 83
      break;
#line 83
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "SimpleTransceiverC$t"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$t[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$t[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "SimpleTransceiverC$end_time"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$end_time[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$end_time[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTransceiverC$during_time"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$during_time[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$during_time[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "SimpleTransceiverC$counter"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$counter[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$counter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTransceiverC$nCountACK"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$nCountACK[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$nCountACK[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "SimpleTransceiverC$random_time"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$random_time[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$random_time[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTransceiverC$addr"))
  {
    *addr = (uintptr_t)&SimpleTransceiverC$addr[__nesc_mote];
    *size = sizeof(SimpleTransceiverC$addr[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  SimpleTransceiverC$t[__nesc_mote] = 15;
  memset((void *)&SimpleTransceiverC$start_time[__nesc_mote], 0, sizeof SimpleTransceiverC$start_time[__nesc_mote]);
  memset((void *)&SimpleTransceiverC$end_time[__nesc_mote], 0, sizeof SimpleTransceiverC$end_time[__nesc_mote]);
  memset((void *)&SimpleTransceiverC$during_time[__nesc_mote], 0, sizeof SimpleTransceiverC$during_time[__nesc_mote]);
  memset((void *)&SimpleTransceiverC$locked[__nesc_mote], 0, sizeof SimpleTransceiverC$locked[__nesc_mote]);
  SimpleTransceiverC$counter[__nesc_mote] = 0;
  SimpleTransceiverC$nCountACK[__nesc_mote] = 0;
  SimpleTransceiverC$max[__nesc_mote] = 2147483647;
  memset((void *)&SimpleTransceiverC$random_time[__nesc_mote], 0, sizeof SimpleTransceiverC$random_time[__nesc_mote]);
  memset((void *)&SimpleTransceiverC$addr[__nesc_mote], 0, sizeof SimpleTransceiverC$addr[__nesc_mote]);
